...
const pageTitle = computed(() => `${siteName.value} | ${t('terms_page.title')}`)
const pageUrl = computed(() => window.location.href)
const pageDesc = computed(() => t('terms_page.intro'))

const sections = [
    { title: 'terms_page.s1_title', body: 'terms_page.s1_body' },
    { title: 'terms_page.s2_title', body: 'terms_page.s2_body' },
    { title: 'terms_page.s3_title', body: 'terms_page.s3_body' },
    { title: 'terms_page.s4_title', body: 'terms_page.s4_body' },
    { title: 'terms_page.s5_title', body: 'terms_page.s5_body' },
    { title: 'terms_page.s6_title', body: 'terms_page.s6_body' },
    { title: 'terms_page.s7_title', body: 'terms_page.s7_body' },
    { title: 'terms_page.s8_title', body: 'terms_page.s8_body' },
]
</script>
...
<template>
    ...
    <div class="min-h-screen overflow-x-hidden bg-white font-sans text-black selection:bg-brutalist-yellow selection:text-black dark:bg-black dark:text-white">
        ...
        <main id="main-content" class="relative py-40 md:py-48">
            <!-- Decorative blobs -->
            <div class="pointer-events-none absolute right-0 top-1/4 h-72 w-72 rounded-full bg-brutalist-pink/10 blur-3xl"></div>
            <div class="pointer-events-none absolute bottom-1/4 left-0 h-96 w-96 rounded-full bg-brutalist-blue/10 blur-3xl"></div>
            ...
            <div class="relative z-10 mx-auto max-w-4xl px-6">
                ...
                <Transition name="fade" mode="out-in">
                    ...
                    <div v-if="!skeletonReady" key="skeleton" class="relative overflow-hidden pointer-events-none select-none">
                        ...
                        <!-- Intro skeleton -->
                        <div class="mb-16 border-l-8 border-brutalist-pink bg-black/5 p-6 dark:bg-white/5 md:p-10">
                        ...
                        <div class="space-y-16">
                            ...
                            >
                                <h2 class="mb-6 inline-block text-2xl font-display font-black uppercase italic leading-tight text-black dark:text-white md:text-3xl">
                                    {{ t(section.title) }}
                                    <span class="block h-1.5 w-0 bg-brutalist-pink transition-all duration-500 group-hover:w-full"></span>
                                </h2>

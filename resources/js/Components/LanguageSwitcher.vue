...
<template>
  <DropdownMenu>      <DropdownMenuTrigger as-child>
      <Button variant="outline" aria-label="Cambiar idioma" class="h-10 px-4 gap-2 rounded-none border-4 border-black dark:border-white bg-white dark:bg-black text-black dark:text-white font-black uppercase italic shadow-brutalist dark:shadow-brutalist-white hover:bg-brutalist-yellow hover:text-black transition-all">
    ...
    <DropdownMenuContent align="end" class="w-40 mt-2 p-0 rounded-none border-4 border-black dark:border-white bg-white dark:bg-black shadow-brutalist dark:shadow-brutalist-white">
      <DropdownMenuItem @select.prevent="changeLanguage('es')" :class="[
      ...
      <DropdownMenuItem @select.prevent="changeLanguage('en')" :class="[
        'cursor-pointer rounded-none px-4 py-3 text-sm font-black uppercase italic transition-colors border-b-2 border-black dark:border-white last:border-b-0',
